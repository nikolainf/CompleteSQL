...
When Not Matched By Source
	Then Delete;";
        ...
        [Test]
        public void SingleMergePredicateSingleAndCondition()
        {
            var people = new[]
            {
                new
...
When Not Matched By Source And tgt.Name Like 'Jo%'
	Then Delete;";
        ...
        [Test]
        public void SingleMergePredicateMultipeAndCondition()
        {
            var people = new[]
            {
                new
...
When Not Matched By Source
	Then Delete;";
        ...
        [Test]
        public void MultipleMergePredicateSingleAndCondition()
        {
            var people = new[]
            {
                new
...
When Not Matched By Source And tgt.Name Like 'Jo%'
	Then Delete;";
        ...
        [Test]
        public void MultipleMergePredicateMultipeAndCondition()
        {
            var people = new[]
            {
                new
