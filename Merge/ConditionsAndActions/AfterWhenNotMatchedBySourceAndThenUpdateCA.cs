...
namespace CompleteSQL.Merge
{
    ...
    public sealed class AfterWhenNotMatchedBySourceAndThenUpdateCA<TSource> : ConditionsAndActionsBase
    {
          internal AfterWhenNotMatchedBySourceAndThenUpdateCA(MergeQueryPartComponent queryComponent)
            : base(queryComponent)
        { }
